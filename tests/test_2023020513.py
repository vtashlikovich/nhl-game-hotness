...
from lib import GameStats, POINTS_COME_BACK, POINTS_MISSED_CHANCE
from utils import load_game, get_found_point_types

# comeback + missed chance
game_id = 2023020513
...
def test_missed_chance(game_stats):
    game_stats.find_missed_chance()
    assert POINTS_MISSED_CHANCE in get_found_point_types(game_stats), 'Missed chance not found'
